        ...
        "light-mode-switch" === e
            ? (t("html").removeAttr("dir"),
              ...
              t("#bootstrap-style").attr(
                  "href",
                  "http://127.0.0.1:8000/admin/assets/css/bootstrap.min.css"
              ),
              t("#app-style").attr("href", "http://127.0.0.1:8000/admin/assets/css/app.min.css"),
            ...
            : 1 == t("#rtl-mode-switch").prop("checked") &&
              ...
              t("#bootstrap-style").attr(
                  "href",
                  "http://127.0.0.1:8000/admin/assets/css/bootstrap-rtl.min.css"
              ),
              t("#app-style").attr("href", "http://127.0.0.1:8000/admin/assets/css/app-rtl.min.css"),
              t("html").attr("dir", "rtl"),
              document.body.setAttribute("data-bs-theme", "light"),
              document.body.setAttribute("data-topbar", "light"),
