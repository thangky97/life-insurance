        ...
        $.fn.extend({
            maxlength: function (options, callback) {
                        ...
                        options.message
                            ...
                            : (options.preText && (output += options.preText),
                              ...
                              options.showMaxLength &&
                                  (output +=
                                      options.separator + maxLengthThisInput),
                        ...
                        if ($.isPlainObject(options.placement))
                            ...
                            switch (
                                (options.appendToParent &&
                                    ((pos.top -= currentInput
                                        .parent()
                                        .offset().top),
                                    (pos.left -= currentInput
                                        .parent()
                                        .offset().left)),
                                options.placement)
                            ) {
                                ...
                                case "top-right-inside":
                                    maxLengthIndicator.css({
                                        top: pos.top - actualHeight,
                                        left:
                                            pos.left + inputOuter - outerWidth,
                                    });
                                    break;
                ...
                function getMaxLength(currentInput) {
                    var max =
                        currentInput.attr("maxlength") ||
                        options.customMaxAttribute;
                    if (options.customMaxAttribute && !options.allowOverMax) {
                        var custom = currentInput.attr(
                            options.customMaxAttribute
                        );
