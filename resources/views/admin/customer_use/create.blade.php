                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-4">Thêm KH sử dụng</h4>
                                ...
                                <form id="frm1" class="custom-validation" action="" method="post"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="customer_name" class="form-control"
                                            value="{{ old('customer_name', isset($request['customer_name']) ? $request['customer_name'] : '') }}">
                                        @error('customer_name')
                                            <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="job" class="form-control"
                                            value="{{ old('job', isset($request['job']) ? $request['job'] : '') }}">
                                        @error('job')
                                            <div>
                                                <p class="text-danger">{{ $message }}</p>
                                            </div>
                                        ...
                                        <div>
                                            <div class="form-file">
                                                ...
                                                @if (isset($customers_use) && $customers_use->customer_photo)
                                                    <img src="{{ asset($customers_use->customer_photo) }}" alt="{{ $customers_use->name }}"
                                                        width="100">
                                                @endif
                                                @error('images')
                                                    <div>
